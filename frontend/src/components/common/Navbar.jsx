    ...
    <div className="w-full flex lg:h-[68px] nav-h-52">
      ...
      >
        ...
        <div className="mr-auto ml-4 xl:mx-0 justify-center items-center xl:flex lg:flex md:flex hidden xl:w-[10%]">
          <span className="cornered_icon_hover mx-4">
            <a
                href="whales"
                className="flex items-center justify-center cornered_icon">
            <img
                src="./assets/images/icon/whale.png"
                className="mx-[47.5px] sm:mx-0 w-[30px] h-[30px]"
            />
            </a>
          </span>
